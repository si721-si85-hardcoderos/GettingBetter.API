...
namespace GettingBetter.API.Tournament_System.Services
{
    ...
    public class RegisterTournamentService : IRegisterTournamentService
    {
        ...
        public RegisterTournamentService(IRegisterTournamentRepository registerTournamentRepository,
            IUnitOfWork unitOfWork, IStudentRepository studentRepository, ITournamentRepository tournamentRepository)
        {
        ...
        public async Task<RegisterTournamentResponse> SaveAsync(RegisterTournament registerTournament)
        {
            ...
            {
                // Error Handling
                return new RegisterTournamentResponse(
                    $"An error occurred while saving the tournament or student: {e.Message}");
            }


        }

        public async Task<RegisterTournamentResponse> UpdateAsync(int registerTournamentId,
            RegisterTournament registerTournament)
        {
            ...
            catch (Exception e)
            {
                // Error Handling
                return new RegisterTournamentResponse(
                    $"An error occurred while updating the register of tournament: {e.Message}");
            }
        ...
        public async Task<RegisterTournamentResponse> DeleteAsync(int registerTournamentId)
        {
            ...
            catch (Exception e)
            {
                // Error Handling
                return new RegisterTournamentResponse(
                    $"An error occurred while deleting the register of tournament: {e.Message}");
            }
