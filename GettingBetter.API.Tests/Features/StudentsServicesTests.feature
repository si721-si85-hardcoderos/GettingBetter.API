Feature: StudentsServiceTest
As a Student
I want to create an account
In order to use the app.

    Background:
        Given the Endpoint https://localhost:8080/api/v1/Students is available

    @coach-register
    Scenario: Register a Student with Unique Email
        When a Post Request is sent
            | FirstName    | LastName             | NickName | Email | Password |
            | Sample name  | Sample LastName      | NickName | Email | 12345678 |
